...
exports.handler = async (event) => {
    ...
    try {
        ...
        const newPiData = await nextPiHandler.getNextPrecision(JSON.parse(getCurrentPiData.Body.toString('utf-8')));
        ...
        const decimalifiedPi = (newPiData.pi.slice(0,1).concat('.')).concat(newPiData.pi.slice(1,));
